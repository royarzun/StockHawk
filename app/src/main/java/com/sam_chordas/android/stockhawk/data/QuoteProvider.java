...
public class QuoteProvider {
    ...
    interface Path{
        ...
        String QUOTES_HISTORIC = "quotes_historical";
    }
    ...
    @TableEndpoint(table = QuoteDatabase.QUOTES_HISTORICAL)
    public static class QuotesHistoricData {
        @ContentUri(
                path = Path.QUOTES_HISTORIC,
                type = "vnd.android.cursor.dir/quote_historical_data"
        )

        public static final Uri CONTENT_URI = buildUri(Path.QUOTES_HISTORIC);
    }
}
